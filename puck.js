...
//Modulo de Documentacion para Usuarios Novatos
 ...
 if (message.content.startsWith(PREFIX + "documentacion")) {
    ...
    .addField("A este Caracter se le llama PREFIX  Ecuacion de Comando:(PREFIX) + (NOMBRE DEL COMANDO) Cada BOT tiene determinados comandos los cuales son enlistados aqui: (Nota: Estos comandos solo son para enviar la lista de los comando preestablecidos en cada uno de los servidores) Puck: >PREFIX {~} >COMANDO ayuda \nEn caso de cualquier error o dificultad para ejecutar cualquiera de estos BOTS, favor de dirigirse con el Administrador o cualquier usuario con el Rol Soporte")
    .addBlankField(true)  
