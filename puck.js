...
//Modulo de Documentacion para Usuarios Novatos
 ...
 if (message.content.startsWith(PREFIX + "documentacion")) {
    ...
    .addField("PREFIX", "Ecuacion de Comando:(PREFIX) + (NOMBRE DEL COMANDO) \nCada BOT tiene determinados comandos los cuales son enlistados aqui: (Nota: Estos comandos solo son para enviar la lista de los comando preestablecidos en cada uno de los servidores) \nPuck: >PREFIX {~} >COMANDO ayuda", true)
    .addBlankField(true)  
    .addField("En caso de cualquier error o dificultad para ejecutar cualquiera de estos BOTS, favor de dirigirse con el Administrador o cualquier usuario con el Rol Soporte", ">_Fin de la Documentacion", true) 
    .addBlankField(true)
  message.channel.send({embed});
  }});
